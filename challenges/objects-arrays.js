...
console.log(`${tyran.name} weighs ${tyran.weight}.`);

// What was the diet of a velociraptor?
console.log(`${velo.name}'s diet was ${velo.diet}.`);

// How long was a stegosaurus?
console.log(`${stego.name} was ${stego.length} long.`);

// What time period did tyrannosaurus live in?
console.log(`${tyran.name} lived in ${tyran.period}`);
...
*/
const smallerPopulation = zooAnimals.filter(animal => animal.population < 5);
